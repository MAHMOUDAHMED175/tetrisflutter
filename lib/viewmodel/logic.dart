...
import 'package:tetrisflutter/viewmodel/properities_shape.dart';

//create game board
List<List<TetrisComponentShapes?>> gameBoard = List.generate(
    columnLength,
    (i) => List.generate(
          rowLength,
          (j) => null,
...
Piece currentPiece = Piece(type: TetrisComponentShapes.A);
...
// create a random object to generate a random shape
  ...
  TetrisComponentShapes randomShape = TetrisComponentShapes
      .values[random.nextInt(TetrisComponentShapes.values.length)];
